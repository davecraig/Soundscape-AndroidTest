...
import org.scottishtecharmy.soundscape.hardware.bose.SensorSample
...
class BleManager(
    ...
    private val onDataReceived: (ByteArray) -> Unit // Callback to send data to the UI/ViewModel
) {
