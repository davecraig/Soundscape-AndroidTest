    ...
    private fun buildCalloutForNearbyPOI(userGeometry: UserGeometry,
        ...
        pois.features.filter { feature ->
            ...
            if(userGeometry.currentBeacon != null) {
                ...
                if(getDistanceToFeature(userGeometry.currentBeacon, feature, gridState.ruler).distance < 1.0) {
                    return@filter true
                }
            }
            ...
            val nearestPoint = getDistanceToFeature(userGeometry.location, feature, gridState.ruler)
            if(category == null) {
                true
            } else {
