...
//    initialFeatureCollections[TreeId.ROADS.id] += getRoadsFeatureCollectionFromTileFeatureCollection(tileFeatureCollection)
//    initialFeatureCollections[TreeId.ROADS_AND_PATHS.id] += getPathsFeatureCollectionFromTileFeatureCollection(tileFeatureCollection)
//    initialFeatureCollections[TreeId.ROADS_AND_PATHS.id] += initialFeatureCollections[TreeId.ROADS.id]
//    initialFeatureCollections[TreeId.INTERSECTIONS.id] += getIntersectionsFeatureCollectionFromTileFeatureCollection(tileFeatureCollection)
...
//    initialFeatureCollections[TreeId.TRANSIT.id] += getTransitFeatureCollectionFromTileFeatureCollection(tileFeatureCollection)
