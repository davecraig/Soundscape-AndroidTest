        ...
        for(layer in mvt.layersList) {
            ...
            for (feature in layer.featuresList) {
                ...
                for (geometry in listOfGeometries) {
                    ...
                    geoFeature.foreign = translateProperties(properties)
...
fun translateProperties(properties: HashMap<String, Any?>?): HashMap<String, Any?>? {
    if(properties == null)
        return null
    ...
    for(property in properties) {
        if (property.key == "class") {
            Log.e("Mvt", "Class ${property.value}")
            when (property.value) {
                "service",
                "secondary",
                "tertiary",
