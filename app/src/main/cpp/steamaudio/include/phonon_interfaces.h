...
namespace api {
    ...
    public:
        ...
        virtual void setStaticMeshMaterial(IStaticMesh *staticMesh, IPLMaterial *newMaterial,
                                           IPLint32 index) = 0;
    };
    ...
    public:
        ...
        virtual void getEnergyField(IPLBakedDataIdentifier *identifier, int probeIndex,
                                    IEnergyField *energyField) = 0;

        virtual void
        getReverb(IPLBakedDataIdentifier *identifier, int probeIndex, float *reverbTimes) = 0;
    };
    ...
    public:
        ...
        virtual void reconstruct(IPLint32 numInputs, const IPLReconstructorInputs *inputs,
                                 const IPLReconstructorSharedInputs *sharedInputs,
                                 IPLReconstructorOutputs *outputs) = 0;
    };
...
IPLVector3 IPLCALL iplCalculateRelativeDirection(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->calculateRelativeDirection(sourcePosition,
                                                                                  listenerPosition,
                                                                                  listenerAhead,
                                                                                  listenerUp);
}
...
IPLerror IPLCALL iplSerializedObjectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createSerializedObject(settings,
                                                                              reinterpret_cast<api::ISerializedObject **>(serializedObject));
}
...
IPLerror IPLCALL iplEmbreeDeviceCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createEmbreeDevice(settings,
                                                                          reinterpret_cast<api::IEmbreeDevice **>(device));
}
...
IPLerror IPLCALL iplOpenCLDeviceListCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createOpenCLDeviceList(settings,
                                                                              reinterpret_cast<api::IOpenCLDeviceList **>(deviceList));
}
...
IPLerror IPLCALL iplOpenCLDeviceCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createOpenCLDevice(
            reinterpret_cast<api::IOpenCLDeviceList *>(deviceList), index,
            reinterpret_cast<api::IOpenCLDevice **>(device));
}
...
IPLerror IPLCALL iplOpenCLDeviceCreateFromExisting(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createOpenCLDeviceFromExisting(
            convolutionQueue, irUpdateQueue, reinterpret_cast<api::IOpenCLDevice **>(device));
}
...
IPLerror IPLCALL iplRadeonRaysDeviceCreate(IPLOpenCLDevice openCLDevice,
    ...
    return reinterpret_cast<api::IOpenCLDevice *>(openCLDevice)->createRadeonRaysDevice(settings,
                                                                                        reinterpret_cast<api::IRadeonRaysDevice **>(rrDevice));
}
...
IPLerror IPLCALL iplTrueAudioNextDeviceCreate(IPLOpenCLDevice openCLDevice,
    ...
    return reinterpret_cast<api::IOpenCLDevice *>(openCLDevice)->createTrueAudioNextDevice(settings,
                                                                                           reinterpret_cast<api::ITrueAudioNextDevice **>(tanDevice));
}
...
IPLerror IPLCALL iplSceneCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createScene(settings,
...
IPLerror IPLCALL iplSceneLoad(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->loadScene(settings,
                                                                 reinterpret_cast<api::ISerializedObject *>(serializedObject),
                                                                 progressCallback,
...
void IPLCALL iplSceneSave(IPLScene scene,
    ...
    reinterpret_cast<api::IScene *>(scene)->save(
            reinterpret_cast<api::ISerializedObject *>(serializedObject));
}
...
IPLerror IPLCALL iplStaticMeshCreate(IPLScene scene,
    ...
    return reinterpret_cast<api::IScene *>(scene)->createStaticMesh(settings,
...
IPLerror IPLCALL iplStaticMeshLoad(IPLScene scene,
    ...
    return reinterpret_cast<api::IScene *>(scene)->loadStaticMesh(
            reinterpret_cast<api::ISerializedObject *>(serializedObject),
...
void IPLCALL iplStaticMeshSave(IPLStaticMesh staticMesh,
    ...
    reinterpret_cast<api::IStaticMesh *>(staticMesh)->save(
            reinterpret_cast<api::ISerializedObject *>(serializedObject));
}
...
iplStaticMeshSetMaterial(IPLStaticMesh staticMesh, IPLScene scene, IPLMaterial *newMaterial,
    ...
    reinterpret_cast<api::IScene *>(scene)->setStaticMeshMaterial(
            reinterpret_cast<api::IStaticMesh *>(staticMesh), newMaterial, index);
}
...
void IPLCALL iplStaticMeshRemove(IPLStaticMesh staticMesh, IPLScene scene) {
    ...
    reinterpret_cast<api::IStaticMesh *>(staticMesh)->remove(
            reinterpret_cast<api::IScene *>(scene));
}
...
IPLerror IPLCALL iplInstancedMeshCreate(IPLScene scene,
    ...
    return reinterpret_cast<api::IScene *>(scene)->createInstancedMesh(settings,
                                                                       reinterpret_cast<api::IInstancedMesh **>(instancedMesh));
}
...
void IPLCALL iplInstancedMeshAdd(IPLInstancedMesh instancedMesh, IPLScene scene) {
    ...
    reinterpret_cast<api::IInstancedMesh *>(instancedMesh)->add(
            reinterpret_cast<api::IScene *>(scene));
}
...
void IPLCALL iplInstancedMeshRemove(IPLInstancedMesh instancedMesh, IPLScene scene) {
    ...
    reinterpret_cast<api::IInstancedMesh *>(instancedMesh)->remove(
            reinterpret_cast<api::IScene *>(scene));
}

void IPLCALL iplInstancedMeshUpdateTransform(IPLInstancedMesh instancedMesh, IPLScene scene,
                                             IPLMatrix4x4 transform) {
    if (!instancedMesh)
        return;

    reinterpret_cast<api::IInstancedMesh *>(instancedMesh)->updateTransform(
            reinterpret_cast<api::IScene *>(scene), transform);
}
...
IPLerror IPLCALL iplAudioBufferAllocate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->allocateAudioBuffer(numChannels, numSamples,
                                                                           audioBuffer);
}
...
void IPLCALL iplAudioBufferConvertAmbisonics(IPLContext context,
    ...
    reinterpret_cast<api::IContext *>(context)->convertAmbisonicAudioBuffer(inType, outType, in,
                                                                            out);
}
...
IPLerror IPLCALL iplHRTFCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createHRTF(audioSettings, hrtfSettings,
                                                                  reinterpret_cast<api::IHRTF **>(hrtf));
}
...
IPLerror IPLCALL iplPanningEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createPanningEffect(audioSettings,
                                                                           effectSettings,
                                                                           reinterpret_cast<api::IPanningEffect **>(effect));
}
...
IPLerror IPLCALL iplBinauralEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createBinauralEffect(audioSettings,
                                                                            effectSettings,
                                                                            reinterpret_cast<api::IBinauralEffect **>(effect));
}
...
IPLerror IPLCALL iplVirtualSurroundEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createVirtualSurroundEffect(audioSettings,
                                                                                   effectSettings,
                                                                                   reinterpret_cast<api::IVirtualSurroundEffect **>(effect));
}
...
IPLerror IPLCALL iplAmbisonicsEncodeEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createAmbisonicsEncodeEffect(audioSettings,
                                                                                    effectSettings,
                                                                                    reinterpret_cast<api::IAmbisonicsEncodeEffect **>(effect));
}

IPLAmbisonicsEncodeEffect IPLCALL
...
IPLerror IPLCALL iplAmbisonicsPanningEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createAmbisonicsPanningEffect(audioSettings,
                                                                                     effectSettings,
                                                                                     reinterpret_cast<api::IAmbisonicsPanningEffect **>(effect));
}

IPLAmbisonicsPanningEffect IPLCALL
...
IPLerror IPLCALL iplAmbisonicsBinauralEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createAmbisonicsBinauralEffect(audioSettings,
                                                                                      effectSettings,
                                                                                      reinterpret_cast<api::IAmbisonicsBinauralEffect **>(effect));
}

IPLAmbisonicsBinauralEffect IPLCALL
...
IPLerror IPLCALL iplAmbisonicsRotationEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createAmbisonicsRotationEffect(audioSettings,
                                                                                      effectSettings,
                                                                                      reinterpret_cast<api::IAmbisonicsRotationEffect **>(effect));
}

IPLAmbisonicsRotationEffect IPLCALL
...
IPLerror IPLCALL iplAmbisonicsDecodeEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createAmbisonicsDecodeEffect(audioSettings,
                                                                                    effectSettings,
                                                                                    reinterpret_cast<api::IAmbisonicsDecodeEffect **>(effect));
}

IPLAmbisonicsDecodeEffect IPLCALL
...
IPLerror IPLCALL iplDirectEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createDirectEffect(audioSettings,
                                                                          effectSettings,
                                                                          reinterpret_cast<api::IDirectEffect **>(effect));
}
...
IPLerror IPLCALL iplReflectionEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createReflectionEffect(audioSettings,
                                                                              effectSettings,
                                                                              reinterpret_cast<api::IReflectionEffect **>(effect));
}
...
IPLAudioEffectState IPLCALL iplReflectionEffectApply(IPLReflectionEffect effect,
    ...
    return reinterpret_cast<api::IReflectionEffect *>(effect)->apply(params, in, out,
                                                                     reinterpret_cast<api::IReflectionMixer *>(mixer));
}
...
IPLerror IPLCALL iplReflectionMixerCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createReflectionMixer(audioSettings,
                                                                             effectSettings,
                                                                             reinterpret_cast<api::IReflectionMixer **>(mixer));
}
...
IPLerror IPLCALL iplPathEffectCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createPathEffect(audioSettings,
                                                                        effectSettings,
                                                                        reinterpret_cast<api::IPathEffect **>(effect));
}
...
IPLerror IPLCALL iplProbeArrayCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createProbeArray(
            reinterpret_cast<api::IProbeArray **>(probeArray));
}
...
void IPLCALL iplProbeArrayGenerateProbes(IPLProbeArray probeArray, IPLScene scene,
                                         IPLProbeGenerationParams *params) {
    if (!probeArray)
        return;

    reinterpret_cast<api::IProbeArray *>(probeArray)->generateProbes(
            reinterpret_cast<api::IScene *>(scene), params);
}
...
IPLerror IPLCALL iplProbeBatchCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createProbeBatch(
            reinterpret_cast<api::IProbeBatch **>(probeBatch));
}
...
IPLerror IPLCALL iplProbeBatchLoad(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->loadProbeBatch(
            reinterpret_cast<api::ISerializedObject *>(serializedObject),
            reinterpret_cast<api::IProbeBatch **>(probeBatch));
}
...
void IPLCALL iplProbeBatchSave(IPLProbeBatch probeBatch,
    ...
    reinterpret_cast<api::IProbeBatch *>(probeBatch)->save(
            reinterpret_cast<api::ISerializedObject *>(serializedObject));
}
...
void IPLCALL iplProbeBatchAddProbeArray(IPLProbeBatch probeBatch,
    ...
    reinterpret_cast<api::IProbeBatch *>(probeBatch)->addProbeArray(
            reinterpret_cast<api::IProbeArray *>(probeArray));
}
...
iplProbeBatchGetEnergyField(IPLProbeBatch probeBatch, IPLBakedDataIdentifier *identifier,
    ...
    reinterpret_cast<api::IProbeBatch *>(probeBatch)->getEnergyField(identifier, probeIndex,
                                                                     reinterpret_cast<api::IEnergyField *>(energyField));
}

void IPLCALL iplProbeBatchGetReverb(IPLProbeBatch probeBatch, IPLBakedDataIdentifier *identifier,
                                    IPLint32 probeIndex, IPLfloat32 *reverbTimes) {
    if (!probeBatch)
        return;

    reinterpret_cast<api::IProbeBatch *>(probeBatch)->getReverb(identifier, probeIndex,
                                                                reverbTimes);
}
...
IPLerror IPLCALL iplSimulatorCreate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->createSimulator(settings,
                                                                       reinterpret_cast<api::ISimulator **>(simulator));
}
...
void IPLCALL iplSimulatorSetScene(IPLSimulator simulator,
    ...
    reinterpret_cast<api::ISimulator *>(simulator)->setScene(
            reinterpret_cast<api::IScene *>(scene));
}
...
void IPLCALL iplSimulatorAddProbeBatch(IPLSimulator simulator, IPLProbeBatch probeBatch) {
    ...
    reinterpret_cast<api::ISimulator *>(simulator)->addProbeBatch(
            reinterpret_cast<api::IProbeBatch *>(probeBatch));
}
...
void IPLCALL iplSimulatorRemoveProbeBatch(IPLSimulator simulator, IPLProbeBatch probeBatch) {
    ...
    reinterpret_cast<api::ISimulator *>(simulator)->removeProbeBatch(
            reinterpret_cast<api::IProbeBatch *>(probeBatch));
}
...
IPLerror IPLCALL iplSourceCreate(IPLSimulator simulator,
    ...
    return reinterpret_cast<api::ISimulator *>(simulator)->createSource(settings,
                                                                        reinterpret_cast<api::ISource **>(source));
}
...
void IPLCALL iplSourceRemove(IPLSource source, IPLSimulator simulator) {
    ...
    reinterpret_cast<api::ISource *>(source)->remove(
            reinterpret_cast<api::ISimulator *>(simulator));
}
...
IPLfloat32 IPLCALL iplDistanceAttenuationCalculate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->calculateDistanceAttenuation(source,
                                                                                    listener,
                                                                                    model);
}
...
void IPLCALL iplAirAbsorptionCalculate(IPLContext context,
    ...
    reinterpret_cast<api::IContext *>(context)->calculateAirAbsorption(source, listener, model,
                                                                       airAbsorption);
}
...
IPLfloat32 IPLCALL iplDirectivityCalculate(IPLContext context,
    ...
    return reinterpret_cast<api::IContext *>(context)->calculateDirectivity(source, listener,
                                                                            model);
}

IPLerror IPLCALL iplEnergyFieldCreate(IPLContext context, IPLEnergyFieldSettings *settings,
                                      IPLEnergyField *energyField) {
    if (!context)
        return IPL_STATUS_FAILURE;

    return reinterpret_cast<api::IContext *>(context)->createEnergyField(settings,
                                                                         reinterpret_cast<api::IEnergyField **>(energyField));
}
...
IPLfloat32 *IPLCALL iplEnergyFieldGetBand(IPLEnergyField energyField, IPLint32 channelIndex,
                                          IPLint32 bandIndex) {
    if (!energyField)
        return nullptr;
...
void IPLCALL iplEnergyFieldAdd(IPLEnergyField in1, IPLEnergyField in2, IPLEnergyField out) {
    ...
    reinterpret_cast<api::IEnergyField *>(out)->add(reinterpret_cast<api::IEnergyField *>(in1),
                                                    reinterpret_cast<api::IEnergyField *>(in2));
}
...
void IPLCALL iplEnergyFieldScale(IPLEnergyField in, IPLfloat32 scalar, IPLEnergyField out) {
    ...
    reinterpret_cast<api::IEnergyField *>(out)->scale(reinterpret_cast<api::IEnergyField *>(in),
                                                      scalar);
}
...
void IPLCALL iplEnergyFieldScaleAccum(IPLEnergyField in, IPLfloat32 scalar, IPLEnergyField out) {
    ...
    reinterpret_cast<api::IEnergyField *>(out)->scaleAccum(
            reinterpret_cast<api::IEnergyField *>(in), scalar);
}

IPLerror IPLCALL iplImpulseResponseCreate(IPLContext context, IPLImpulseResponseSettings *settings,
                                          IPLImpulseResponse *impulseResponse) {
    if (!context)
        return IPL_STATUS_FAILURE;

    return reinterpret_cast<api::IContext *>(context)->createImpulseResponse(settings,
                                                                             reinterpret_cast<api::IImpulseResponse **>(impulseResponse));
}
...
void IPLCALL iplImpulseResponseCopy(IPLImpulseResponse src, IPLImpulseResponse dst) {
    ...
    reinterpret_cast<api::IImpulseResponse *>(dst)->copy(
            reinterpret_cast<api::IImpulseResponse *>(src));
}
...
void IPLCALL iplImpulseResponseSwap(IPLImpulseResponse ir1, IPLImpulseResponse ir2) {
    ...
    reinterpret_cast<api::IImpulseResponse *>(ir2)->swap(
            reinterpret_cast<api::IImpulseResponse *>(ir1));
}
...
iplImpulseResponseAdd(IPLImpulseResponse in1, IPLImpulseResponse in2, IPLImpulseResponse out) {
    ...
    reinterpret_cast<api::IImpulseResponse *>(out)->add(
            reinterpret_cast<api::IImpulseResponse *>(in1),
            reinterpret_cast<api::IImpulseResponse *>(in2));
}
...
iplImpulseResponseScale(IPLImpulseResponse in, IPLfloat32 scalar, IPLImpulseResponse out) {
    ...
    reinterpret_cast<api::IImpulseResponse *>(out)->scale(
            reinterpret_cast<api::IImpulseResponse *>(in), scalar);
}
...
iplImpulseResponseScaleAccum(IPLImpulseResponse in, IPLfloat32 scalar, IPLImpulseResponse out) {
    ...
    reinterpret_cast<api::IImpulseResponse *>(out)->scaleAccum(
            reinterpret_cast<api::IImpulseResponse *>(in), scalar);
}

IPLerror IPLCALL iplReconstructorCreate(IPLContext context, IPLReconstructorSettings *settings,
                                        IPLReconstructor *reconstructor) {
    if (!context)
        return IPL_STATUS_FAILURE;

    return reinterpret_cast<api::IContext *>(context)->createReconstructor(settings,
                                                                           reinterpret_cast<api::IReconstructor **>(reconstructor));
}
...
void IPLCALL iplReconstructorReconstruct(IPLReconstructor reconstructor, IPLint32 numInputs,
    ...
    reinterpret_cast<api::IReconstructor *>(reconstructor)->reconstruct(numInputs, inputs,
                                                                        sharedInputs, outputs);
}
