...
class MvtTileTest {
    ...
    fun testNaptanBusStopOmitsMissingLocalityName() {
        ...
        assertEquals(
            ...
            getTextForFeature(null, stance2).text
        )
    }
     ...
     * getTextForFeature reformats this to "CommonName, Locality Directionbound" using the
    ...
    fun testNaptanBusStopNameFormatting() {
        ...
        assertEquals(
            ...
            getTextForFeature(null, lynnDrive).text
        )
        ...
        assertEquals(
            ...
            getTextForFeature(null, roseleaDrive).text
        )
    }
    ...
    fun testNaptanBusStopLandmarkSuffix() {
        ...
        assertEquals(
            ...
            getTextForFeature(null, mainStreet).text
        )
    }
    ...
    fun testNaptanBusStopRedundantLandmarkSuppressed() {
        ...
        assertEquals(
            ...
            getTextForFeature(null, ashfieldRoad).text
        )
    }
