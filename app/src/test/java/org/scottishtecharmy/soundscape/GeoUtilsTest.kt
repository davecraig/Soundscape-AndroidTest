...
class GeoUtilsTest {
    ...
    fun distanceToPolygonTest(){
        val ruler = CheapRuler(1.0, metres)
        val polygonObject = Polygon().also {
            it.coordinates = arrayListOf(
                arrayListOf(
                    LngLatAlt(0.0, 1.0),
        ...
        val minDistanceToPolygon1 = distanceToPolygon(LngLatAlt(0.0, -1.0), polygonObject, ruler)
        Assert.assertEquals(111319.49, minDistanceToPolygon1, 800.0)
        val minDistanceToPolygon2 = distanceToPolygon(LngLatAlt(0.0, 2.0), polygonObject, ruler)
        Assert.assertEquals(111319.49, minDistanceToPolygon2, 800.0)
    ...
    fun cheapTestPoint(ruler: CheapRuler, point: LngLatAlt, line: LineString, fc: FeatureCollection) {
        val pdh = ruler.pointOnLine(line, point)
    ...
    fun cheapRulerTest() {
        ...
        val ruler = CheapRuler(51.431658, metres)
