...
class RTreeParityTest {
    ...
    fun boxSearchMatchesRtree2() {
        ...
        val theirs =
            mutableListOf<com.github.davidmoten.rtree2.Entry<Item, com.github.davidmoten.rtree2.geometry.Geometry>>()
        ...
        repeat(2000) { i ->
            ...
            when (i % 3) {
                ...
                1 -> {
                    val x1 = rng.nextDouble(-10.0, 10.0);
                    val y1 = rng.nextDouble(-10.0, 10.0)
                    val x2 = x1 + rng.nextDouble(-0.5, 0.5);
                    val y2 = y1 + rng.nextDouble(-0.5, 0.5)
                    ...
                    val x = rng.nextDouble(-10.0, 10.0);
                    val y = rng.nextDouble(-10.0, 10.0)
                    val w = rng.nextDouble(0.01, 0.5);
                    val h = rng.nextDouble(0.01, 0.5)
        ...
        repeat(50) {
            val qx1 = rng.nextDouble(-10.0, 10.0);
            val qy1 = rng.nextDouble(-10.0, 10.0)
            val qx2 = qx1 + rng.nextDouble(0.1, 4.0);
            val qy2 = qy1 + rng.nextDouble(0.1, 4.0)
    ...
    fun nearestMatchesRtree2() {
        ...
        repeat(30) {
            val qx = rng.nextDouble(-10.0, 10.0);
            val qy = rng.nextDouble(-10.0, 10.0)
