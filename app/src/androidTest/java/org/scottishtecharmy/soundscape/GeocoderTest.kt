...
class GeocoderTest {
    ...
    private suspend fun describeLocation(geocoder: SoundscapeGeocoder, userGeometry: UserGeometry): LocationDescription? {
    ...
    private fun reverseGeocodeLocation(
        ...
        runBlocking {
            ...
            val deferredResults = list.map { geocoder ->
                async { describeLocation(geocoder, userGeometry) }
            }
