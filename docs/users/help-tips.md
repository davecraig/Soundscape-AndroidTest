...
If you still want to interact with Soundscape but don’t want to hear automatic callouts you can turn callouts off by going to the *"Callouts"* section of the *"Settings"* screen from the menu. Or, if you aren’t going to be using Soundscape you can put it in either Sleep or Snooze mode using the *"Sleep"* button on the home screen.
